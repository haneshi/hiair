...
<%@ page import="hiair_project1.model.Flight" %>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/flight_view.css">
